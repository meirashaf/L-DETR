...
from .pplcnet import PPLCNetEngine
...
class BackboneBase(nn.Module):
    ...
    def __init__(self, backbone: nn.Module, train_backbone: bool, num_channels: int, return_interm_layers: bool):
        ...
        for name, parameter in backbone.named_parameters():
            if not train_backbone or 'blocks2' not in name and 'blocks3' not in name and 'blocks4' not in name\
                    and 'blocks5' not in name and 'blocks6' not in name and 'last_conv' not in name\
